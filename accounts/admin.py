...
class UserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        (('Personal info'), {'fields': ('first_name', 'last_name', 'email', 'integral', 'level', 'nickname')}),
...
class UserAddressAdmin(admin.ModelAdmin):
    """ 用户地址管理 """
    list_display = ('user', 'province', 'city', 'area', 'username', 'address', 'phone', 'is_valid', 'is_default')
