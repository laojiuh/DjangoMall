...
class Order(models.Model):
    ...
    to_area = models.CharField('省市区', max_length=128)
...
class Cart(models.Model):
    """ 购物车 """
    user = models.ForeignKey(User, related_name='carts', verbose_name='用户名')
...
class Comments(models.Model):
    ...
    img_list = GenericRelation(ImageFile, verbose_name='评价晒图', related_query_name='img-list')
